...
void TransformReflectionRegister(){
    FieldFunctionTuple* field_function_tuple_translation = new FieldFunctionTuple(
        ...
        &TransformReflection::getClassName,
        &TransformReflection::getFieldName_translation,
        &TransformReflection::getFieldTypeName_translation);
    GlobalMetaInfoManager::registerToFieldMap("Transform", field_function_tuple_translation);
    ...
    GlobalMetaInfoManager::registerToFieldMap("Transform", field_function_tuple_rotation);
    ...
    GlobalMetaInfoManager::registerToFieldMap("Transform", field_function_tuple_scale);
}
}
