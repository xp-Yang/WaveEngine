...
void RenderPipeline::render()
{
    if (m_render_params.pipeline_type == PIPELINE_TYPE::FORWARD) {
        ...
        if (m_render_params.shadow) {
            //m_shadow_pass->config(m_render_params.shadow_map_sample_count);
            m_shadow_pass->config_samples(m_render_params.shadow_map_sample_count);
            m_shadow_pass->draw();
        ...
        //m_main_camera_pass->config(m_render_params.msaa_sample_count, m_render_params.reflection, m_render_params.normal_debug, m_render_params.wireframe);
        m_main_camera_pass->config_samples(m_render_params.msaa_sample_count);
